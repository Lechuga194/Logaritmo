    ...
    return page === "home" ? (
        <div className={styles.home}>
            <div className={styles.bannerHome}>
                ...
                <p id={styles.textHome}>
                    Sigue paso a paso el procedimiento matemático para resolver
            ...
            <div className={styles.contentHome}>
                <div className={styles.formula}>
                    <p className={styles.text}>
                        Recordemos la fórmula del interés compuesto
                    </p>
                    <img src={formula1} alt="M=C(1+i)^n"></img>
                    <p className={styles.text}>
                        Introduce los datos deseados para encontrar el número de
                        años{" "}
                    </p>
                    {error ? (
                        <p className={styles.error}>
                            ¡Solo debes introducir números mayores que 0!
                        </p>
                    ) : (
                        void 0
                    )}
            ...
            <div className={styles.bannerResultados}>
                {windowWidth <= 900 ? (
                    <div className={styles.responsivebanner}>
                        <img src={btnback} alt="Regresar" onClick={back}></img>
                        <p id={styles.title}>LOGARITMO</p>
                    </div>
                ) : (
                    <p id={styles.title}>LOGARITMO</p>
                ...
                <div className={styles.rigthPanel}>
                    ...
                    <div className={styles.sustitucion}>
                        ...
                        <p>
                            3.{" "}
                            <span>
                                log({monto}/{capital}) = log(1 + {interes})^n
                            </span>
                        </p>
                        <p>
                            4.{" "}
                            <span>
                                log({monto}/{capital}) = n log(1 + {interes})
                            </span>
                        </p>
                        <p>
                            5.{" "}
                            <span>
                                n = log({monto}/{capital})/log(1 + {interes})
                            </span>
                        </p>
                    </div>
                    <div className={styles.resultado}>
                        ...
                        <p>
                            <span>
                                n = {Math.log(monto / capital)} /{" "}
                                {Math.log(1 + interes)} ={" "}
                                {Math.log(monto / capital) /
                                    Math.log(1 + interes)}
                            </span>
                        </p>
                        <p>
                            Resultado: <span>{resultado.toFixed(2)} Años</span>
                        </p>
                    </div>
                </div>
            </div>
